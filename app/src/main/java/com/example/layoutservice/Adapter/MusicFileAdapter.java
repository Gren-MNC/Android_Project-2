...
public class MusicFileAdapter extends RecyclerView.Adapter<MusicFileAdapter.MusicFileHolder> {
    ...
    @NonNull
    @Override
    public MusicFileHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_sub_single, parent,false);
        return new MusicFileHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MusicFileHolder holder, int position) {
    ...
    public MusicFileAdapter(Context context,ArrayList<MusicFiles> musicFilesArrayList){
    ...
    public class MusicFileHolder extends RecyclerView.ViewHolder{
        ...
        public MusicFileHolder(@NonNull View v){
            super(v);
